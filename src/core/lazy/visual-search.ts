...
export function openVisualSearchInterface(): void {
  ...
  dragSvg.setAttribute('width', '48');
  dragSvg.setAttribute('height', '48');
  dragSvg.setAttribute('viewBox', '0 0 24 24');
  dragSvg.setAttribute('fill', 'none');
  dragSvg.setAttribute('class', 'visual-search-drag-icon');
  ...
  dragPath.setAttribute('fill', 'currentColor');
