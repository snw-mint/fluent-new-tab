...
const togglePerformanceMode = getById<HTMLInputElement>('togglePerformanceMode');
const performanceWarningNotice = getById<HTMLDivElement>('performanceWarningNotice');
